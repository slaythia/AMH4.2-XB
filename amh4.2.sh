...
echo "[${Installcurl} Installing] ************************************************** >>";
   ...
   cd $AMHDir/packages;
   Downloadfile "${AMHcurl}.tar.gz" " http://om3ak721x.bkt.clouddn.com/${AMHcurl}.tar.gz";
...
function InstallReady()
{
	...
	cd $AMHDir/packages;
	wget http://om3ak721x.bkt.clouddn.com/conf.zip;
...
function InstallLibiconv()
{
	...
	Downloadfile "${LibiconvVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${LibiconvVersion}.tar.gz";
...
function InstallOpenSSL()
{
	...
	Downloadfile "${OpenSSLVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${OpenSSLVersion}.tar.gz";
...
if [ "$confirm"  == '1' ]; then
	...
	Downloadfile "${Mysql55Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Mysql55Version}.tar.gz";
...
if [ "$confirm"  == '2' ]; then
	...
	Downloadfile "${Mysql56Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Mysql56Version}.tar.gz";
...
if [ "$confirm"  == '3' ]; then
    cd $AMHDir/packages/
    wget http://om3ak721x.bkt.clouddn.com/boost_1_59_0.tar.gz;
	# [dir] /usr/local/mysql/
	echo "[${Mysql57Version} Installing] ************************************************** >>";
	Downloadfile "${Mysql57Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/mysql-boost-5.7.17.tar.gz";
...
if [ "$confirm"  == '4' ]; then
	...
	Downloadfile "${Mariadb55Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Mariadb55Version}.tar.gz";
...
if [ "$confirm"  == '5' ]; then
	...
	Downloadfile "${Mariadb10Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Mariadb10Version}.tar.gz";
...
function InstallPhp()
{
	...
	Downloadfile "${Php56Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Php56Version}.tar.gz";
...
function InstallPhp53()
{
	...
	Downloadfile "${Php53Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Php53Version}.tar.gz";
...
function InstallPhp54()
{
	...
	Downloadfile "${Php54Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Php54Version}.tar.gz";
...
function InstallPhp55()
{
	...
	Downloadfile "${Php55Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Php55Version}.tar.gz";
...
function InstallPhp70()
{
	...
	Downloadfile "${Php70Version}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${Php70Version}.tar.gz";
...
function InstallNginx()
{
	...
	Downloadfile "${NginxVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${NginxVersion}.tar.gz";
	Downloadfile "${NginxCachePurgeVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${NginxCachePurgeVersion}.tar.gz";
	...
	if [ ! -d /usr/local/nginx ]; then
		...
		./configure --prefix=/usr/local/nginx --user=www --group=www --with-http_ssl_module  --with-http_gzip_static_module --without-mail_pop3_module --without-mail_imap_module --without-mail_smtp_module --without-http_uwsgi_module --without-http_scgi_module --with-ipv6 --with-stream --with-http_v2_module --with-openssl=/usr/local/$OpenSSLVersion --add-module=$AMHDir/packages/untar/$NginxCachePurgeVersion;
	    cd /usr/local/$OpenSSLVersion;
		./config;
	    #./config --prefix=/usr/local/openssl --shared zlib;
	     #make -j $Cpunum;
...
function InstallPureFTPd()
{
	...
	Downloadfile "${PureFTPdVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${PureFTPdVersion}.tar.gz";
...
function InstallAMH()
{
	...
	Downloadfile "${AMHVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${AMHVersion}.tar.gz";
	...
	if [ ! -d /home/wwwroot/index/web ]; then
        ...
        #sed -i 's/Nginx 1.9.9/'$NginxVersion'/g' /home/wwwroot/index/web/View/index.php;
        #sed -i 's/Mariadb-10.1.13/'$Mariadb10Version'/g' /home/wwwroot/index/web/View/index.php;
		#sed -i 's/PHP 5.6.12/'$Php56Version'/g' /home/wwwroot/index/web/View/index.php;
...
function InstallAMS()
{
	...
	Downloadfile "${AMSVersion}.tar.gz" "http://om3ak721x.bkt.clouddn.com/${AMSVersion}.tar.gz";
